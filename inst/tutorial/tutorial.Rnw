...
\SweaveOpts{prefix.string=C:/Programme/R/R-2.12.1/Eigene_Pakete/svn/RNetLogo/tutorial/images/}
...
could be "C:/Program Files/NetLogo 4.1.3/".
...
version 5. The default value of \verb@nl.version@ is 4, which means, that we don't have
to submit this parameter when using NetLogo 4.x.
...
\begin{figure}
  \centering
    \includegraphics{C:/Programme/R/R-2.12.1/Eigene_Pakete/svn/RNetLogo/tutorial/images/NLandR1}
...
plot(cells, xlim=x.minmax, ylim=y.minmax)
@

\begin{figure}
  \centering
    \includegraphics{C:/Programme/R/R-2.12.1/Eigene_Pakete/svn/RNetLogo/tutorial/images/NLandR_GetAgentSet1}
...
patches <- NLGetPatches(c("pxcor","pycor","pcolor"),
                        "patches",
                        as.data.frame=TRUE,
                        df.col.names=c("x","y","pcolor"))
# convert to SpatialPointsDataFrame
coordinates(patches) <- ~ x + y
...
spplot(patches, 'pcolor', col.regions=col)
@
...
\begin{figure}
  \centering
    \includegraphics{C:/Programme/R/R-2.12.1/Eigene_Pakete/svn/RNetLogo/tutorial/images/NLandR_SetPatches1}
...
database.path = "C:/Programme/R/R-2.12.1/Eigene_Pakete/svn/RNetLogo/tutorial/test_netlogo.db"
...
\begin{figure}
  \centering \includegraphics{C:/Programme/R/R-2.12.1/Eigene_Pakete/svn/RNetLogo/tutorial/images/NLandR_TimeSlider}
