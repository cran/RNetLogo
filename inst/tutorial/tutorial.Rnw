...
\SweaveOpts{prefix.string=C:/Users/jthiele/own_packages/rnetlogo/pkg/RNetLogo/inst/tutorial/images/}
...
could be "C:/Program Files/NetLogo 5.0.4/".
...
to submit this parameter when using NetLogo 5.0.x.
...
\begin{figure}
  \centering
    \includegraphics{C:/Users/jthiele/own_packages/rnetlogo/pkg/RNetLogo/inst/tutorial/images/NLandR1}
...
\begin{figure}
  \centering
    \includegraphics{C:/Users/jthiele/own_packages/rnetlogo/pkg/RNetLogo/inst/tutorial/images/NLandR_GetAgentSet1}
...
NLCommand("random-seed 2147483646")
@
...
\begin{figure}
  \centering
    \includegraphics{C:/Users/jthiele/own_packages/rnetlogo/pkg/RNetLogo/inst/tutorial/images/NLandR_SetPatches1}
...
This will save the NetLogo object reference in a variable \verb@_nl.intern_@ in the local environment \verb@.rnetlogo@. If 
...
in the third argument of \verb@NLStart@ like this:
...
All functions, presented above, take as last (optional) argument the referece name of 
the NetLogo instance (nl.obj). Therefore, we can specify which instance we want 
...
database.path = "C:/Users/jthiele/own_packages/rnetlogo/pkg/RNetLogo/inst/tutorial/test_netlogo.db"
...
@
<<label=quitall, echo=FALSE, results=hide>>=
NLQuit(all=T)
@
\begin{figure}
  \centering \includegraphics{C:/Users/jthiele/own_packages/rnetlogo/pkg/RNetLogo/inst/tutorial/images/NLandR_TimeSlider}
